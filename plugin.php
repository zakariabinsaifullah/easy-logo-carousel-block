<?php
/**
 * Plugin Name:       Easy Logo Carousel Block
 * Description:       <strong>Easy Logo Carousel Block</strong> is a Custom <strong>Gutenberg Block</strong> developed with Swiper Js library and Gutenberg Native Components to showcase clients logos in a sliding mode.
...
final class ALCB_BLOCKS_CLASS {
	...
	private function alcb_define_constants() {
		...
		define( 'ALCB_INC_URL', ALCB_URL . 'includes/' );	
	}
	...
	*/
	...
	public function alcb_external_libraries() {
		...
		if( ! is_admin() ){
			// enqueue css
			wp_enqueue_style( 'alcb-swiper-css', ALCB_INC_URL . 'lib/css/swiper-bundle.css', array(), '8.1.4', 'all' );
			// enqueue JS
			wp_enqueue_script( 'alcb-swiper-js', ALCB_INC_URL . 'lib/js/swiper-bundle.js', array(), '8.1.4', true );
			wp_enqueue_script( 'alcb-logo-slider', ALCB_INC_URL . 'assets/js/logo-slider.js', array(), ALCB_VERSION, true );
		}
	}
